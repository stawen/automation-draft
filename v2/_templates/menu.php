  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="accueil-backend.php"><i class="fa fa-area-chart"></i> <span>Dashboard</span></a></li>
        
        <li><a href="inventaire.php"><i class="fa fa-search"></i> <span>Inventaire</span></a></li>
        
        <li class="treeview">
          <a href="#"><i class="fa fa-search"></i> <span>Inventaire</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#">Dernier reboot</a></li>
          </ul>
        </li>
        
        
        <li><a href="#"><i class="fa fa-cubes"></i> <span>Constructions</span></a></li>
        
        <li><a href="#"><i class="fa fa-trash"></i> <span>Démantèlements</span></a></li>
